...
class ColorGridWindow(QMainWindow):
   ...
   # Объединенная ячейка для Row 1-7 (столбцы 0-2)
        ...
        label_6_4 = QLabel("Видео финальное")
        ...
        label_7_4 = QLabel("Конспект исходный")
        ...
        label_8_1 = QLabel("Объединенная ячейка 1-2")
        label_8_1.setAlignment(Qt.AlignCenter)
        cell_8_1.setLayout(QVBoxLayout())
        cell_8_1.layout().setContentsMargins(0, 0, 0, 0)
        cell_8_1.layout().addWidget(label_8_1)
        ...
        label_8_4 = QLabel("Изображения исходные")
        ...
        btn_10_0 = QPushButton("Сохранить")
